# Two different experiments by https://github.com/ryanag1/Experiments-and-system-integration
## Basic system consisting of NGINX, Vue, Ducts(Python server), and Redis by Docker-Compose.
...
### 2.3 RTT measurement results (Left side: LAN; Right side: WAN)
![2022-05-26 (15)](https://user-images.githubusercontent.com/106264576/171652218-5963c002-9ed4-4fbe-8594-c9113a61ea86.png)

***

## 1. Realtime communications in Unity by Ducts client for C# (made by me!) and aioredis (Redis)
